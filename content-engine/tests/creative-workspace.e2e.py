...
with sync_playwright() as playwright:
    ...
    def mock_outline(route):
        if "latest-run" in route.request.url:
            route.fulfill(status=200, content_type="application/json", body='{"id":"11111111-1111-4111-8111-111111111111","status":"SUCCEEDED","createdAt":"2026-07-27T08:00:00.000Z","confirmation":{"model":"qwen-plus","platform":"WECHAT","actionVersion":"creative-outline:1.0.0","skills":[]}}')
            return
